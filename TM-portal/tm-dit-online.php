...
function change()
{
   ...
   {
      case "1":
      document.getElementById("change").innerHTML = "<strong>NB: IMAGES SHOULD BE NO BIGGER 1MB EACH.</strong><br><sup>*</sup>1. damage in detail:<br><input class='formText' type='file' name='photo1' class='warrantySelectText' style='width:270px;'></div>"
	  
      break;


   case "2":
   document.getElementById("change").innerHTML = "Please send your images via Email or MMS, within 5 day of submitting this form, <?php if ($country == 'ausDealers'){ echo 'to <a class=\'surfboardPg\' href=\'mailto:chris@surfindustries.com\'>Chirs Pothof</a>.  ';} elseif (($country == 'usDealers') || ($country == 'hiDealers') || ($country == 'usSUPDealers')) { echo 'to your Territory Manager. Contact details can be found on the <a class=\'surfboardPg\' href=\'usDealersContact.php\'>Contacts page</a>. ';}elseif ($country == 'nzDealers'){ echo 'to your Territory Manager. Contact details can be found on the <a class=\'surfboardPg\' href=\'nzDealersContact.php\'>Contacts page</a>. ';}elseif ($country == 'territoryManager'){ echo '&nbsp;';} ?>."
        ...
        <div class="main-container">
            <section class="page-title page-title-4 image-bg overlay parallax">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="uppercase mb0">TM PORTAL</h2><h4>DIT Claim Form</h4>
                        </div>
                    </div>
                    <!--end of row-->
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-md-push-3">
                            <form action="tm-dit-online-confirmation.php" name="warrantyForm" id="warrantyForm" onsubmit="return validateForm();" enctype="multipart/form-data" method="post">
                           ...
                           <div class="col-md-8 col-sm-10 ">
							...
							<div class="col-md-8 col-sm-10 ">
                               ...
                               <div class="col-md-6 col-sm-10 ">
                                ...
                                <div class="col-md-8 col-sm-10 ">
									<div class="heading-title">Description<br><hr></div>
							   </div>
                               <div class="col-md-6 col-sm-10 ">
