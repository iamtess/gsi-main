        ...
        <div class="main-container">
            <section class="page-title page-title-4 image-bg overlay parallax">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="uppercase mb0">TM PORTAL</h2><h4>CPIP Product Issue confirmation</h4>
                        </div>
                    </div>
                    <!--end of row-->
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-md-push-3">
                            ...
                            Thanks your CPIP Product issue has been submitted.<p>You will receive an email to confirm this submission.
