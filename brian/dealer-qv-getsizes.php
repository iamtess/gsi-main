...
$data = json_decode($content, true);
	...
	<div class="container">
		...
		<div class="col-md-9 col-sm-12 ">
			<div class="col-md-3 mb8"><a class="TMquickLink" href="dealer-quick-view-type.php?warehouse='.$_POST['locations'].'"><div class="TMquickLinks">VIEW by TYPE</div></a></div>
	...
	foreach($data as $row) {
		...
		echo '<tr>'; //display relevant brand logo
			...
			echo '<td valign="top" style="min-width:60px;padding-right:15px;">';
				...
				echo '<tr>';
					echo '<td valign="top">';
						...
						foreach ($models['colours'] as $model_color){
							...
							echo '<td  valign="top" class="smallText" style="width:150px;padding-right:10px;padding-bottom:10px;">';
