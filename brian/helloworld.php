...
$urlx = "https://rest.netsuite.com/app/site/hosting/restlet.nl?script=130&deploy=1&subsidiary=[5,9,10]";
...
$data = json_decode($content, true);
		...
		echo "<table>";
		echo "<tr><td>ID</td><td>Name</td><td>Country</td><td>Currency</td></tr>";
		
foreach($data as $subsidiary) {
		...
		echo "</td>";
		echo "<td>";
		echo $subsidiary['name'];
		echo "</td>";
		echo "<td>";
		echo $subsidiary['country'];
		echo "</td>";
		echo "<td>";
		echo $subsidiary['currency'];
		echo "</td>";
		echo "</tr>";
		echo "</tr>";
}
