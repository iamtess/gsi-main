...
echo '                <div class="background-image-holder">';
 echo '<img src="../images/tm-portal-header.jpg" class="background-image" alt="Global Surf Industries - Dealer Portal">'; 
...
echo '                        <div class="col-md-9">';
		...
		echo '<br><br><br>
				<div class="col-md-4 mb8"><form action="brian-create-an-order-dealer.php"><input type="submit" value="CREATE ORDER / ACC HISTORY" class="hollow" onsubmit></form></div><div class="col-md-4 mb8"><form action="../dealer-admin/dealer-admin.php?warehouse=$warehouse"><input type="submit" value="GO TO GSI DEALER ADMIN" class="hollow" onsubmit></form></div>
		...
		if ($data ['status'] == 'error'){
			echo '<H3 style="color:red;"><br>ORDER DENIED</H3>';
			echo '<p>Hi '. $tm_name .', </p>';
			echo '<p>Close but no cigar.<br><br>Daisy could not process this order because:<span style="color:red;"><strong> '.$data['message'].'</strong></span>';
			echo '<p>Love from Brian x</p>';
		}
		else {
			echo '<H3><br>ORDER CONFIRMATION</H3>';
			echo '<p>Thankyou '. $tm_name .', </p>';
			echo '<p>';
			echo 'I have sent your order to Daisy.<br><br>Your order ID is: <strong>'. $data['tranid'].'</strong></p><p>Love from Brian x</p>';
		}
		
		echo '<br><br><br>
				<div class="col-md-4 mb8"><form action="brian-create-an-order.php"><input type="submit" value="CREATE ANOTHER ORDER" class="hollow" onsubmit>
				</form></div><div class="col-md-4 mb8"><form action="../TM-portal/tm-portal-links.php"><input type="submit" value="GO TO TM PORTAL"  class="hollow" onsubmit></form></div>
