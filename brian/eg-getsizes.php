...
$data = json_decode($content, true);
	...
	<tr>
	<td>
	<div style="width:180px;height:22px;background:#87ccf3;border-radius: 8px;text-align:center;" class="brandicon"><div class="expander" ><a style="font-size:11px; font-weight:regular; text-decoration: none; letter-spacing:1px; font-family: \'Josefin Sans\', serif;color:#ffffff;font-weight:bold;" href="#">SHOW/HIDE TRADE PRICE</a></div></div></td><td><div style="width:150px;height:22px;background:#87ccf3;border-radius: 8px;text-align:center;" class="brandicon"><div  class="expander" ><a style="font-size:11px; font-weight:regular; text-decoration: none; letter-spacing:1px; font-family: \'Josefin Sans\', serif;color:#ffffff;font-weight:bold;" href="#startClearance">CLEARANCE STOCK</a></div></div></td></tr></table>';
	...
	foreach($data as $row) {
		...
		echo '<tr>'; //display relevant brand logo
			...
			if ($row['brand_id'] == '9999'){
				...
				echo '<img src="https://www.surfindustries.com/images/brian-logo-brand-id-smll-'.$row['brand_id'].'.gif" title="brandlogo" id="brandlogo"/></td>';
			echo '<td valign="top" style="font-size:15px; font-weight:regular; font-family: \'Josefin Sans\', serif;color:#000000;">';
								...
								echo '<table cellpadding="0" cellspacing="8" border="0">';
									echo '<tr>';
										...
										echo '<td valign="top" style="font-size:17px; font-weight:bold; font-family: \'Josefin Sans\', serif;color:#000000;">size</td>
											<td valign="top" style="font-size:17px; font-weight:bold; font-family: \'Josefin Sans\', serif;color:#000000;">stock</td>
											...
											<td valign="top" style="font-size:17px; font-weight:bold; font-family: \'Josefin Sans\', serif;color:#000000;">retail</td>
									...
									echo '<td valign="top"  style="text-align:left;font-size:12px;font-weight:regular; font-family: \'Josefin Sans\', serif;color:#000000;">';
									   ...
									   {	
										...
										echo '<td valign="top"  style="text-align:left;font-size:12px;font-weight:regular; font-family: \'Josefin Sans\', serif;color:#000000;">';
										echo '<input class="sizeInput"  type="text" id="rrp'.$count.'" name="rrp[]"  value="$'.$rrp.'"  disabled style="width:65px;"></td>';	
			 ...
			 echo '<tr>';
			 echo '<td colspan = "2">';
			 echo '<a style="text-align:left;font-size:10px;font-weight:regular; font-family: \'Josefin Sans\', serif;color:#000000;" href=#orderSummary>View Order Summary</a><br><hr>';
			 echo '</td>';
			 echo '</tr>';
	}
echo '</table>';
