...
echo " get sizes brand open, customer: ".$_POST['customer']."<br><br>";
...
$wlocation = $_POST['locations'];
	echo '<br><br>Warehouse location:' .$wlocation;
...
echo "<br><br>data above / content below";
...
try {
 ...
 if ($wlocation == '47'){
	...
	foreach($data as $row) {
		...
		echo '<div class="col-md-4 mb8 expander"><a class="TMquickLink" href="#"><div class="TMquickLinks">SHOW/HIDE TRADE PRICE</div></a></div>
			</div>
		</div>
	</div>';
		}
								  ...
								  <td class="quickViewTable" valign="top" ><strong>total</strong></td>
									...
									echo '<td valign="top"  style="text-align:left;font-size:12px;font-weight:regular; ">';
									   ...
									   {	
										...
										echo '<input type="text" id="rrp'.$count.'" name="rrp[]"  value="'.$sizeCurrency.$rrp.'"  disabled style="padding-left:0px;height:18px;background-color:#ffffff;"></td>';	
										...
										echo '<td valign="top"  style="font-size:12px;font-weight:regular; ">';
										echo '<span  class="text"><input class="sizeInput"  type="text" id="price'.$count.'" name="price[]"  value="'.$sizeCurrency.$tradePrice.'"  disabled style="padding-left:0px;height:18px;background-color:#ffffff;"></span></td>';
										echo '<td valign="top"  style="font-size:12px;font-weight:regular; ">';
