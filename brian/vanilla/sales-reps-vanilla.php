...
$urlx = "https://rest.netsuite.com/app/site/hosting/restlet.nl?script=customscriptgsi_r_brian_salesreps&deploy=1";
...
$data = json_decode($content, true);
		...
		echo "<table>";
		echo "<tr><td>ID</td><td>Name</td><td>Warehouse/Subsidiary</td></tr>";
