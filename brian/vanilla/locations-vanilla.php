...
//send request to daisy for warhous elocations returns: id, name, subsidiary_id
$urlx = "https://rest.netsuite.com/app/site/hosting/restlet.nl?script=customscriptgsi_r_brian_locations&deploy=1";
...
$data = json_decode($content, true);
		...
		echo "<table>";
		echo "<tr><td>ID</td><td>Name</td><td>Subsidiary id</td></tr>";
