...
$urlx = "https://rest.netsuite.com/app/site/hosting/restlet.nl?script=customscriptgsi_r_brian_models&deploy=1&brands=[1,17,8]";
...
$data = json_decode($content, true);
		...
		echo "<table>";
		echo "<tr><td>ID</td><td>Name</td><td>Brand ID</td></tr>";
