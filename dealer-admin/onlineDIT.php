        ...
        <div class="main-container">
            <section class="page-title page-title-4 image-bg overlay  parallax">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="uppercase mb0">DEALER PORTAL</h2><h4>DIT Claim Form</h4>
                        </div>
                    </div>
                    <!--end of row-->
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-md-push-3">
                            <form action="onLineDITConfirm.php" name="warrantyForm" id="warrantyForm" onsubmit="return validateForm();" enctype="multipart/form-data" method="post">
							<input type="hidden" value="<?php $_SESSION['country'] ?>" name="country">
							<?php if ($country == 'ausDealers'){ echo '<input type="hidden" value="mk" name="TM">'; } ?>
                                		...
                                		<select required name="TM">
											<option value="">Select your territory manager</option>';
												...
												if  ($country == 'usDealers'){ 	
													echo '<option value="eg">Ed Gerbino</option>
