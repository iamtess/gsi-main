    ...
    <head>
       ...
       <title>GLOBAL SURF INDUSTRIES - DISTRIBUTOR PORTAL</title>
		...
		if (isset($_POST['txtUserId']) && isset($_POST['txtPassword'])) 
		{
			...
			if ($login === 'distributor' && $pwd === 'cokes') {
				...
				header('Location: dist-portal-links.php');
				exit;
			} 
        ...
        <div class="main-container">
            <section class="cover fullscreen image-bg overlay">
                <div class="background-image-holder">
                   <?php echo "<img src='" . IMAGES_DIR ."login-bground.jpg' class='background-image' alt='Global Surf Industries - Distributor Portal Login'>"; ?>
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
                            <div class="feature bordered text-center">
                                <h4 class="uppercase">DISTRIBUTOR PORTAL LOGIN</h4>
