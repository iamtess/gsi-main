...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>GLOBAL SURF INDUSTRIES - CONTACTS - AUSTRALIA</title>
         <?php 
		define( "HOME", "../" ); 
        ...
        <div class="main-container">
           <section class="page-title page-title-4 image-bg overlay ">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="uppercase mb0">AUSTRALIAN CONTACTS</h3>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-md-5">
                            ...
                            <hr />
							<div class="col"><p><strong>CUSTOMER SERVICE LINE / GENERAL ENQUIRIES</strong></p></div>
                            <p>
                            <div class="col"><i class="ti-email">&nbsp;</i> <a class="contactLink" href="mailto:info@surfindustries.com">info@surfindustries.com</a></div>
							<div class="col"><i class="ti-mobile">&nbsp;</i> <tel>1300 857 791</tel> (TOLL FREE)<br /></div>
                            ...
                            <hr>
						<p> <div class="col"><strong>SALES / Finance / ACCOUNT CUSTOEMR SERVICE LINE</strong></div>
								<div class="col">Mark Kelly</div>
                                <div class="col"><i class="ti-email">&nbsp;</i> <a class="contactLink" href="mailto:dave@surfindustries.com">kel@surfindustries.com</a></div>
						<div class="col"><i class="ti-mobile">&nbsp;</i> <tel>0403 045 159</tel></div>
								
                            </p>
                            <hr>
                            
                            <p> <div class="col"><strong>GENERAL OPERATION ENQUIRIES</strong></div>
								<div class="col">Mark Kelly</div>
                                <div class="col"><i class="ti-email">&nbsp;</i> <a class="contactLink" href="mailto:dave@surfindustries.com">kel@surfindustries.com</a></div>
						<div class="col"><i class="ti-mobile">&nbsp;</i> <tel>0403 045 159</tel></div>
						...
						<div class="col"><i class="ti-mobile">&nbsp;</i> <tel>0403 045 159</tel></div>
                            ...
                            <p> <div class="col"><strong>POSTAL DETAILS</strong></div>
								<div class="col">General Correspondence</div>
								<div class="col">PO Box 1049, Manly NSW 1655</div>
								</p>
							  <hr>
                            <p> <div class="col"><strong>FACTORY OUTLET ADDRESS</strong></div>
								<div class="col">2/20 William Street</div>
								<div class="col">Brookvale, NSW 2100</div>
