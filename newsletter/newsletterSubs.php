        ...
        <div class="main-container">
            <section class="page-title page-title-2 image-bg overlay ">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-10">
							<h2 class="uppercase mb8">SUBSCRIBE TO OUR NEWSLETTER</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-sm-10 ">
							<p class="regularText">Be the first to hear about our new products, competitions and give aways.</p>
							<p class="regularText">NB: All fields are required.
							</p>
						</div>
				      ...
				      <div class="col-md-6 col-sm-10 ">
				       <!-- <label>First Name</label>
				        <input type="text" value="" name="FNAME" required id="mce-FNAME" placeholder="first name"> -->
					    <label>Email Address</label>
					    <input type="text" value="" name="EMAIL" required id="mce-EMAIL" placeholder="email address">
						<label>Country</label>
					...
					<!--	<label>Birth Year (optional)</label>
						<div class="select-option">
                        <i class="ti-angle-down"></i>
							<select name="BIRTHYEAR" placeholder="birth year" id="mce-BIRTHYEAR">
					...
					<!--	<label>Gender (optional)</label>
						<div class="select-option">
                        <i class="ti-angle-down"></i>
							<select name="GENDER" class="" id="mce-GENDER" placeholder="gender">
					...
					<div style="color:darkseagreen;font-size:14px;font-weight:bold;" class="response  " id="mce-error-response" style="display:none"></div>
					<div style="color:darkseagreen;font-size:14px;font-weight:bold;" class="response  " id="mce-success-response" style="display:none"></div>
					</div> 
					</div>
			        </div>
				   ...
				   <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_d70e70edf08c660f1ae4fb4ea_bd79415f06" tabindex="-1" value=""></div>
				      <div class="col-md-3 col-sm-10 mt24 ">	
						<input class="hollow" type="submit" value="SUBSCRIBE" name="subscribe" id="mc-embedded-subscribe" />
				       ...
				       <div class="col-md-10 col-sm-10 ">
					    <a class="labelLink" href="#fins" onclick="toggle_visibility('list1');"><strong>PRIVACY COLLECTION STATEMENT</strong></a>
							<div id="list1" class="alist" style="display:none;"><br>
								<p>Your personal information is being collected by Blue Ball Pty Limited ACN 100 906 867 trading as Global Surf Industries (“GSI”). Your personal information is collected by GSI for the purposes of selling you our products or providing you with our services. Your personal information may be used for business purposes including marketing and sales of our products and services and for recording statistical data for market analysis. If GSI is unable to collect your personal information, GSI may be unable to sell you products and/or provide you services.</p><p>Your personal information may be disclosed to other GSI group companies and non-GSI group companies, such as service providers, either in Australia or in the following countries: Australia, New Zealand, United States of America.</p><p>Information about how you may access the personal information held about you and seek correction of such information is contained in our Privacy Policy.<p><p>Our Privacy Policy contains information about how you may make a complaint about a breach of the Australian Privacy Principles and how GSI will deal with such a complaint. Read our <a class="regular" href="https://www.surfindustries.com/gsi-privacy.php" target="new">Privacy Policy in full</a> or for more details call: AUS 1300 857 791| USA 855 474 6821 | NEW ZEALAND 09 889 6050.
								</p>
							</div>	
					</div>	
