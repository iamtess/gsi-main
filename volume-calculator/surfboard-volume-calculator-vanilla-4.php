...
<html>
	...
	<div class="main-container">
           <section class="page-title page-title-4 image-bg overlay ">
            ...
            <section class="pb0 pt32">
                <div class="container">
                   <div class="row">
                        <div class="col-sm-12">
                            <h3 class="uppercase mb64 mb-xs-32">FIND THE BEST VOLUME FOR YOU</h3>
                        </div>
                    </div>
                    <div class="row">
		...
		if (isset($_POST["AmountRL"]) && !empty($_POST["AmountRL"])) {
			...
			echo '<section class="pt0 pb16 mb8">';
            echo '<div class="container">';
            echo '<div class="row">';
            echo '<div class="col-md-12 col-sm-10 pb16">';
			echo '<hr><br><br>';
			echo '<h4 class="uppercase">RECOMMENDED BOARDS & VOLUME FOR YOUR SKILL LEVEL</h4>';
			echo '<h5>YOUR SKILL LEVEL: '.$skillval.' </h5>';
			echo '<h5>YOUR VOLUME:  '.$med .'ltr ';
			echo '<h5>PLEASE NOTE: This is only a suggested volume. Please hit the Live chat button below if you need more info.</h5>';
