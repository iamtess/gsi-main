...
function createContext($url, $ckey, $csecret, $tkey, $tsecret){
	...
	$urlx = "https://rest.na2.netsuite.com/app/site/hosting/restlet.nl?script=242&deploy=1&volume=" . $_POST["smallVolume"];

	$countryURL = $_POST["country"];

	//https://rest.na2.netsuite.com/app/site/hosting/restlet.nl?script=customscriptgsi_r_brian_locations&deploy=1&salesrep=" . $_POST["salesrep"];
	...
	$data = json_decode($content, true);
		...
		if ($_POST["smallVolume"] > 0){
			
			
			echo '<section class="pt0">';
            echo '<div class="container">';
            echo '<div class="row">';
			echo '<div class="col-sm-12 col-sm-10">';
			echo '<div class="heading-title">SMALL, MUSHY CONDITIONS (0 – 3 feet)<br><hr></div>';
			echo '</div>';
			echo '<div class="col-md-12 col-sm-10">';
			echo '<p>For small mushy conditions your recommended volume is '. $_POST["smallVolume"].'ltr (+/- 2ltr). These boards should suit you:<p>';
			echo '</div>';
			foreach($data as $row) {
