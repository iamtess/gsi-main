...
//if(isset($_POST["salesrep"]) && !empty($_POST["salesrep"])){
	...
	$urlx = "https://rest.na2.netsuite.com/app/site/hosting/restlet.nl?script=242&deploy=1&volume=" . $_POST["largeVolume"];
	...
	$data = json_decode($content, true);
		...
		if ($_POST["largeVolume"] > 0){
			...
			echo '<div class="heading-title">LARGE, PUNCHY CONDITIONS  (6 feet plus)<br><hr></div>';
			echo '</div>';
			echo '<div class="col-md-12 col-sm-10">';
			echo '<p>For small mushy conditions your recommended volume is '. $_POST["largeVolume"].'ltr (+/- 2ltr). These boards should suit you:<p>';
			echo '</div>';
			foreach($data as $row) {
